...
**Disclaimer:**
**งานที่ทำละทดสอบใน Windows 11** Linux/MacOS อาจมี bug และโปรดตรวจสอบขอบเขต IP ในตัวแปร `networks_to_scan` ภายในช่วงไฟล์ `main.py` ให้ถูกต้อง การนำโปรแกรมนี้ไปสแกนรหัสผ่านหรือช่องโหว่เซิร์ฟเวอร์ในระบบเครือข่ายผู้อื่นโดยไม่ได้รับอนุญาตอาจถือเป็นความผิดตามกฎหมาย พัฒนาเครื่องมือนี้ไว้เพื่อศึกษาคอนเซปต์ของ Threading และ Network Development ในสภาพแวดล้อมแบบปิด (Lab) เท่านั้น
...
การสแกนเครือข่ายแต่ละรพับประกอบไปด้วยชุดคำสั่งที่อาศัยการเข้าถึงเครือข่ายระดับ OS:
...
![ภาพประกอบการทำงานส่วนที่ 2](images/image2.png)
*(ผลลัพธ์เจาะลึกการรันและล็อกอินผ่าน SSH พอร์ตต่างๆ)*
